...
namespace PointOfSale
{
    public class DAL
    {
            ...
            public SqlConnection GetConnection()
            {
                ...
                con.ConnectionString = "Data Source=DESKTOP-9OI7PLO;Initial Catalog=db_pointofsale;Integrated Security=True;Encrypt=False";
                return con;
            }
            ...
            {
                paralist.Add(new SqlParameter(paraname, value));  //action,update
            }
